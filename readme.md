This is a cloned repository of Javascript30 that I am going to complete as a part of The Odin Project. Each file that ends in -START.html will be the file in which I enter all of the code. Any that end in -FINISHED.html will be the code that was premade as a reference for the course.
